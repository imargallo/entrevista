...
public class StepDefinitions {
	...
	@And("fills")
	public void fillsWith(DataTable data) throws IllegalAccessException {
		List<Map<String, String>> fieldlist = data.asMaps(String.class, String.class);
		for (Map<String, String> e : fieldlist) {
			jhon.fillsField(e.get("field"), e.get("value").toString());
		}
	}
